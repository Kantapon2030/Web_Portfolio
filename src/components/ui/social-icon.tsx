...
export const ButtonSocialIconDemo: React.FC<ButtonSocialIconDemoProps> = ({
  ...
  const socialLinks: SocialItem[] = [
    ...
    },
    {
      ...
      icon: (
        <svg
          className="w-5 h-5 sm:w-6 sm:h-6 fill-current text-neutral-100"
          viewBox="0 0 24 24"
          aria-hidden="true"
        >
          <path
...

    {
      ...
      icon: (
        <svg
          className="w-5 h-5 sm:w-6 sm:h-6 fill-[#1877F2]"
          viewBox="0 0 24 24"
          aria-hidden="true"
        >
      ...
      {socialLinks.map((item) => (
        <a
          ...
          className={`
            ...
            w-16 h-12 sm:w-20 sm:h-14 rounded-2xl
            transition-all duration-300 ease-out
            hover:-translate-y-1 active:scale-95
            ${
              isDark
                ? 'bg-[#121217] border border-neutral-800/90 shadow-[0_4px_20px_rgba(0,0,0,0.6)] hover:bg-[#181820] hover:border-neutral-700 hover:shadow-[0_8px_25px_rgba(0,0,0,0.8)]'
                : 'bg-white border border-neutral-200/90 shadow-[0_4px_16px_rgba(0,0,0,0.06)] hover:bg-neutral-50 hover:border-neutral-300 hover:shadow-[0_8px_24px_rgba(0,0,0,0.1)]'
            }
          `}
        >
